...
class Menu:
    def __init__(self, window):
        self.window = window
        self.surf = pygame.image.load('./asset/MenuBg.png').convert_alpha() #carregou imagem
    ...
    def run(self, ):
        ...
        while True:
            #DRAW IMAGES
            self.window.blit(source=self.surf, dest=self.rect)  # dizemos que a imagem tem que aparecer no retangulo
